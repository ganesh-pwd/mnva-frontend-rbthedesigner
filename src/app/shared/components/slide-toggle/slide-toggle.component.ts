  ...
  getSingleItem() {
   ...
   openDialog() {
    ...
    if (this.status === 'Active') {
      ...
      title = 'Active Your Databox';
      content = 'Are you sure you want to active your databox?';
    }
    ...
    this.mainDataboxesDialogService.confirm({
      ...
      if ( this.status === 'Active' && result ) {
        ...
        this.databoxesService
          .updateItem(this.id, Object.assign(this.data, {status: 'Paused'}));
        this.getSingleItem();
      }
      ...
      if ( this.status === 'Paused' && result ) {
        this.selectedOption = true;
        this.databoxesService
          .updateItem(this.id, Object.assign(this.data, {status: 'Active'}));
        this.getSingleItem();
      }
    });
  }
