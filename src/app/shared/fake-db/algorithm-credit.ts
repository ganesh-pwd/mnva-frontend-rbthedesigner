export class AlgorithmCreditsDB {
  public algorithm_credit = [
    ...
    {
      '_id': 1,
      'name': 'Gender author Algorithm',
      'subtitle': 'Admodum assentior ad duo',
      'description': 'Lorem ipsum dolor sit amet, et nec putent quodsi, admodum assentior ad duo. Pri ad sapientem ocurreret incorrupte.',
      'category': 'Gender author Algorithm',
      'tags': [
        'sunt',
        'sunt',
        'culpa'
    ...
    },
    {
      ...
      'subtitle': 'Admodum assentior ad duo',
      'description': 'Lorem ipsum dolor sit amet, et nec putent quodsi, admodum assentior ad duo. Pri ad sapientem ocurreret incorrupte.',
      'category': 'Image recognition Algorithm',
      'tags': [
        'sunt',
        'sunt',
        'culpa'
    ...
    {
      '_id': 3,
      'name': 'Lorem Ipsum Algorithm',
      'subtitle': 'Admodum assentior ad duo',
      'description': 'Lorem ipsum dolor sit amet, et nec putent quodsi, admodum assentior ad duo. Pri ad sapientem ocurreret incorrupte.',
      'category': 'Lorem Algorithm',
      'tags': [
        'sunt',
        'sunt',
        'culpa'
    ...
    {
      '_id': 4,
      'name': 'Ipsum Algorithm',
      'subtitle': 'Admodum assentior ad duo',
      'description': 'Lorem ipsum dolor sit amet, et nec putent quodsi, admodum assentior ad duo. Pri ad sapientem ocurreret incorrupte.',
      'category': 'Ipsum Algorithm',
      'tags': [
        'sunt',
        'sunt',
        'culpa'
